...
def drive(cfg, model_path=None, use_joystick=False, model_type=None, camera_type='single', meta=[]):
    ...
    if cfg.STOP_SIGN_DETECTOR:
        from src.donkey.part import RMRacerCV
        V.add(RMRacerCV(cfg), inputs=['cam/image_array', 'pilot/throttle', 'pilot/angle', 'pilot/brake', 'speed'], outputs=['cam/image_array', 'pilot/throttle', 'pilot/angle', 'pilot/brake'], threaded=True)
